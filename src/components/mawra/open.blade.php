<div>
    ...
    <form action="{{route('fmt.mawra.store')}}" method="post" class="fmt_box" enctype='multipart/form-data'>
    ...
    <div class="my-12 py-4 px-4 border border-gray-400 shadow-lg">
        <div>Import csv</div>
        <form class="flex flex-wrap" action="{{route('fmt.mawra.csv_upload')}}" method="POST" enctype='multipart/form-data'>
            @csrf
